    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                ...
                '<div class="layui-tab-item layui-show" lay-item-id="-1"><iframe src="welcome.page"></iframe></div>',
                '</div>',
                '</div>'
            ];
            //渲染
        ...
        tabAdd: function(options) {
            ...
            titleHtm.push('</li>');
            var contentHtm = '<div class="layui-tab-item layui-show" lay-item-id="' + id + '"><iframe src="' + url + '"></iframe></div>';
            //追加htm
